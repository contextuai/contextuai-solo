...
// Coder-mode sidebar (Phase 4 PR 5).
// Mirrors the Solo sidebar but with Coder-specific nav items.
const navItems: NavItem[] = [
  { label: "Projects", path: "/coder/projects", icon: FolderKanban },
  { label: "Running", path: "/coder/running", icon: Play },
  { label: "Templates", path: "/coder/templates", icon: LayoutTemplate },
  { label: "Models", path: "/models", icon: Cpu },
  { label: "Settings", path: "/settings", icon: Settings },
];

export default function DesktopSidebarCoder() {
